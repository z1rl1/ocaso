...
public class CannonControllerlvl5 : MonoBehaviour
{
    public static CannonControllerlvl5 Instance; // Статическая ссылка для доступа из других скриптов
    ...
    public void Fire()
    {
        StartCoroutine(ShootAfterDelay(0f)); // Стрелять сразу
    }
